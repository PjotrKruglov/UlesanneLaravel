...
CREATE DATABASE IF NOT EXISTS `moviesdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_estonian_ci;
USE `moviesdb`; -- andmebaasi loomine

CREATE TABLE `actor` (
  `actor_id` smallint(5) UNSIGNED NOT NULL,
  `firstname` varchar(50) NOT NULL,
  `lastname` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8; -- tabeli loomine
...
ALTER TABLE `actor`
  ...
  ADD KEY `idx_actor_lastname` (`lastname`); -- võtmete lisamine ja indekseerimine
...
ALTER TABLE `actor`
  MODIFY `actor_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10; -- tabeli välja muutmine
ALTER TABLE `category`
...
ALTER TABLE `film` -- välisvõtmete lisamine
